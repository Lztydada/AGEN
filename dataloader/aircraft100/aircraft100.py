...
class Fgvc_aircraft(Dataset):
    ...
    def _pre_operate(self, root):
        image_file = os.path.join(root, 'fgvc-aircraft-2013b/images.txt')
        split_file = os.path.join(root, 'fgvc-aircraft-2013b/train_test_split.txt')
        class_file = os.path.join(root, 'fgvc-aircraft-2013b/image_class_labels.txt')
        ...
        if self.train:
            for k in train_idx:
                image_path = os.path.join(root, 'fgvc-aircraft-2013b/images', id2image[k])
