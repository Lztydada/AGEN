...
def set_up_datasets(args):
    ...
    if args.dataset == 'my_data':
        import dataloader.my_data.my_data as Dataset
        args.base_class = 60
        args.num_classes = 100
        args.way = 5
        args.shot = 5
    ...
    if args.dataset == 'aircraft100':
        import dataloader.aircraft100.aircraft100 as Dataset
        args.base_class = 60
        args.num_classes = 100
        args.way = 5
        args.shot = 5
    ...
    if args.dataset == 'car100':
        import dataloader.car100.car100 as Dataset
        args.base_class = 60
        args.num_classes = 100
        args.way = 5
        args.shot = 5
...
def get_transform(args):
    ...
    if args.dataset in ['cub200','my_data','aircraft100','car100']:
...
def get_base_dataloader(args):
    ...
    if args.dataset == 'cifar100':
        ...
        testset = args.Dataset.CIFAR100(root=args.dataroot, train=False, download=False, index=class_index,
                                        base_sess=True)
    if args.dataset == 'car100':
        trainset = args.Dataset.CAR100(root=args.dataroot, train=True, index=class_index, base_sess=True,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
        testset = args.Dataset.CAR100(root=args.dataroot, train=False, index=class_index)
    if args.dataset == 'cub200':
    ...
    if args.dataset == 'my_data':
        trainset = args.Dataset.Mydata(root=args.dataroot, train=True, index=class_index, base_sess=True,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
        testset = args.Dataset.Mydata(root=args.dataroot, train=False, index=class_index)
    if args.dataset == 'aircraft100':
        trainset = args.Dataset.Fgvc_aircraft(root=args.dataroot, train=True, index=class_index, base_sess=True,
                                              crop_transform=crop_transform, secondary_transform=secondary_transform)
        testset = args.Dataset.Fgvc_aircraft(root=args.dataroot, train=False, index=class_index)
    if args.dataset == 'mini_imagenet':
...
def get_new_dataloader(args, session):
    ...
    if args.dataset == 'cub200':
        trainset = args.Dataset.CUB200(root=args.dataroot, train=True, index_path=txt_path,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
    if args.dataset == 'car100':
        trainset = args.Dataset.CAR100(root=args.dataroot, train=True, index_path=txt_path,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
    if args.dataset == 'my_data':
        trainset = args.Dataset.Mydata(root=args.dataroot, train=True, index_path=txt_path,
                                       crop_transform=crop_transform, secondary_transform=secondary_transform)
    if args.dataset == 'aircraft100':
        trainset = args.Dataset.Fgvc_aircraft(root=args.dataroot, train=True, index_path=txt_path,
                                              crop_transform=crop_transform, secondary_transform=secondary_transform)
    if args.dataset == 'mini_imagenet':
    ...
    if args.dataset == 'cub200':
        testset = args.Dataset.CUB200(root=args.dataroot, train=False,
                                      index=class_new)
    if args.dataset == 'car100':
        testset = args.Dataset.CAR100(root=args.dataroot, train=False,
                                      index=class_new)
    if args.dataset == 'my_data':
        testset = args.Dataset.Mydata(root=args.dataroot, train=False,
                                      index=class_new)
    if args.dataset == 'mini_imagenet':
        testset = args.Dataset.MiniImageNet(root=args.dataroot, train=False,
                                            index=class_new)
    if args.dataset == 'aircraft100':
        testset = args.Dataset.Fgvc_aircraft(root=args.dataroot, train=False,
                                             index=class_new)
